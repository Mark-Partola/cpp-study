...
private:
    ...
    vector<string> GetLatest (int year, string part) {
        vector<string> name;
    ...
    vector<string> GetHistory (int year, string part) {
        vector<string> name;
        string prev;
    ...
    string FormatName (const vector<string>& fst_names, const vector<string>& lst_names, function<string(vector<string>)> f) {
        if (fst_names.size()) {
            if (lst_names.size()) {
